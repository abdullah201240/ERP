        ...
        <div className='bg-[#433878] p-8 rounded-xl'>
          ...
          <form className="grid grid-cols-1 gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className='text-white mb-2'>Projected Start Date</label>
                <input
                  type="date"
                  id="projected-start-date"
                  name="projected-start-date"
                  className="block w-full rounded-md border-gray-300 shadow-sm focus:border-[#8c0327] focus:ring-[#8c0327] focus:ring-opacity-50 p-2 bg-gray-100 mt-2"
                />
              </div>
              <div>
                <label className='text-white mb-2'>Projected End Date</label>
                <input
                  type="date"
                  id="projected-end-date"
