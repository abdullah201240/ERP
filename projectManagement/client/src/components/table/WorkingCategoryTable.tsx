...
interface WorkingCategoryTableProps {
    reload: boolean;
}
const WorkingCategoryTable: React.FC<WorkingCategoryTableProps> = ({ reload }) => {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}workingDrawing/category/${deleteId}`, {
                method: 'DELETE',
                headers: {
                    'Authorization': token,
    ...
    const saveEdit = async () => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}workingDrawing/category/${editCategory.id}`, {
                method: 'PUT',
                headers: {
                    'Authorization': token,
...
export default WorkingCategoryTable;