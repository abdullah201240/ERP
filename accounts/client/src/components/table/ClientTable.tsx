    ...
    const fetchProjects = useCallback(async () => {
        try {
            ...
            const response = await fetch(
                `${process.env.NEXT_PUBLIC_API_URL_PROJECTMANAGEMENT}projects/view-all-projects/${employeeDetails.sisterConcernId}?page=${currentPage}&limit=${itemsPerPage}&search=${searchQuery}`, 
                {
                  method: 'GET',
                  headers: { Authorization: `Bearer ${token}` },
