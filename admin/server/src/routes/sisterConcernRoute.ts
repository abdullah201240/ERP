...
import {  createSister, deleteCompany, getAllCompany, getProfile, loginSister, logoutCompany, updateCompany } from "../controllers/companyController";
...
router.get("/sisterConcern", getAllCompany);
