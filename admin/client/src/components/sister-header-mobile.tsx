...
import { SIDENAV_ITEMS_SISTER } from '@/sister-constants';
import { SideNavItem } from '@/types';
import { Icon } from '@iconify/react';
import { motion, useCycle } from 'framer-motion';
import {  SVGMotionProps } from 'framer-motion'; // Import SVGMotionProps
...
const HeaderMobile = () => {
  ...
  return (
    ...
    >
      ...
      >
        {SIDENAV_ITEMS_SISTER.map((item, idx) => {
          const isLastItem = idx === SIDENAV_ITEMS_SISTER.length - 1;
