...
import CreateSisterConcern from '@/components/CreateSisterConcern';
  ...
  return (
    <div>
      <div className="bg-[#F1F2F3] pl-0 mt-2">
        <h1 className="text-2xl text-black">All Sister Concern</h1>

        <div className="bg-white mt-8 p-4 rounded-xl">
          <h1 className="text-center text-xl ">Add Sister Concern</h1>
